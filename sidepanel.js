    ...
    await chrome.scripting.executeScript(
        {
            ...
            func:grabGoods,
			args : [ minprice, maxprice, quantity, delay, motloh],
        },
...
async function grabGoods(minprice, maxprice, quantity, delay, motloh) {
	console.log(motloh.length);
	var mlinks = new Map();
	var sortalinks = [];
	maxprice = maxprice*100;
	minprice = minprice*100;
	let maincontainer = document; //.querySelector('div[mod-name="gmod-h5-rax-sd-item-list-v2"]')
	if(maincontainer)
	{
